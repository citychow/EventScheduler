 ...
 *
 * Usage:
 *   node scheduler.js (run immediately then schedule)
 *
 * API key:
...
console.log('Schedule:   every Friday at 14:00 - Only edit ecosystem.config.js for schedule');
